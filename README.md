...
* Insup не воспринимает шаблоны в имени которых встречается кириллица, например: `page.Новая_страница.liquid`. Если в теме присутсвуют такие шаблоны, работать с Insup не выйдет.
